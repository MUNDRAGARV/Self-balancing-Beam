...
float desired_angle = 10; //This is the angle in which we want the rotor to stay
...
void loop() 
{
   ...
   * begin functions we have to put this value.*/
   ...
   /---X---/
   Gyro_angle[0] = mpu6050.getAngleX()/131.0; 
   /---Y---/
   Gyro_angle[1] = mpu6050.getAngleY()/131.0;
...
error = (desired_angle - mpu6050.getAngleX());
